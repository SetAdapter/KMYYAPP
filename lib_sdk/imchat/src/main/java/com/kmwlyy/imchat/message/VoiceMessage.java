...
public class VoiceMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        LinearLayout linearLayout = new LinearLayout(TimApplication.getContext());
        linearLayout.setOrientation(LinearLayout.HORIZONTAL);
        linearLayout.setGravity(Gravity.CENTER);
        ImageView voiceIcon = new ImageView(TimApplication.getContext());
        ...
        getBubbleView(viewHolder,true).addView(linearLayout);
    ...
    public String getSummary() {
        return TimApplication.getContext().getString(R.string.summary_voice);
    }

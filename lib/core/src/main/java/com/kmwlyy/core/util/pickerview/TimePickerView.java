package com.kmwlyy.core.util.pickerview;
...
import com.kmwlyy.core.util.pickerview.lib.WheelView;
import com.kmwlyy.core.util.pickerview.listener.CustomListener;
import com.kmwlyy.core.util.pickerview.view.BasePickerView;
import com.kmwlyy.core.util.pickerview.view.WheelTime;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    public static class Builder {
        private int layoutRes = R.layout.layout_pickview_time;
        private CustomListener customListener;
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            LayoutInflater.from(context).inflate(R.layout.layout_pickview_time, contentContainer);

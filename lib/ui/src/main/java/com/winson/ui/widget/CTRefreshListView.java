...
public class CTRefreshListView extends ListView {
	...
	public void changeHeaderState(State state) {// 下拉状态切换
		...
		case ORIGNAL:
			...
			tv_title.setText(this.getResources().getString(R.string.string_down_refresh));
		...
		case RELEASE_TO_REFRESH:
			tv_title.setText(this.getResources().getString(R.string.string_release_refresh));
			iv_arrow.clearAnimation();
		...
		case REFRESHING:
			...
			tv_title.setText(this.getResources().getString(R.string.string_refreshing));
			iv_arrow.clearAnimation();
	...
	public void onHeaderRefreshComplete() {// 下拉完成
		...
		tv_time.setText(this.getResources().getString(R.string.string_update_time) + sdf.format(new Date()));
		changeHeaderState(State.ORIGNAL);
		isLoading = false;
	}

...
public class BuyIMConsultFamilyActivity extends BaseActivity implements View.OnClickListener{
    public static final String TAG = BuyIMConsultFamilyActivity.class.getSimpleName();
...
//    public static final int SELECT_USER_MEMBER_REQ = 10001;
    ...
    public static void startBuyIMConsultFamilyActivity(Context context, String doctorId, String doctorName, int consultType, boolean isGroup) {
        Intent intent = new Intent(context, BuyIMConsultFamilyActivity.class);
...
//                uploadImageClient.start();
    ...
    private void createRecordAndPay(List<HttpUserConsults.ImageFile> imageFiles, final int type) {
        ...
        if (mIsGroup){
            HttpUserConsults.AddGroup addUserConsult = new HttpUserConsults.AddGroup(
                    id,
                    mDoctorID,
                    imageFiles,
                    consultContent,
                    ...
                    new HttpListener<UserConsult.AddResp>() {
                        ...
                        public void onError(int code, String msg) {
                            ...
                            if (mConsultType == HttpUserConsults.FREE) {
                                ToastUtils.show(BuyIMConsultFamilyActivity.this, R.string.create_im_consult_free_failed, Toast.LENGTH_SHORT);
                            } else if (mConsultType == HttpUserConsults.DUTY) {
                                ToastUtils.show(BuyIMConsultFamilyActivity.this, R.string.create_im_consult_duty_failed, Toast.LENGTH_SHORT);
                            } else {
                                ToastUtils.show(BuyIMConsultFamilyActivity.this, R.string.create_im_consult_record_failed, Toast.LENGTH_SHORT);
                            }
                            if (msg != null) {
                                try {
                                    JSONObject data = new JSONObject(msg);
                                    ToastUtils.show(BuyIMConsultFamilyActivity.this, data.getString("ErrorInfo"), Toast.LENGTH_SHORT);
                        ...
                        public void onSuccess(UserConsult.AddResp data) {
                            ...
                            if (!"Success".equals(data.mActionStatus)) {
                                dismissCreateConsultDialog();
                                ToastUtils.show(BuyIMConsultFamilyActivity.this, data.mErrorInfo, Toast.LENGTH_SHORT);
                                return;
                            }
                            if (mConsultType == HttpUserConsults.FREE) {
                                ToastUtils.show(BuyIMConsultFamilyActivity.this, R.string.create_im_consult_free_success, Toast.LENGTH_SHORT);
                            } else if (mConsultType == HttpUserConsults.DUTY) {
                                ToastUtils.show(BuyIMConsultFamilyActivity.this, R.string.create_im_consult_duty_success, Toast.LENGTH_SHORT);
                            } else {
                                ToastUtils.show(BuyIMConsultFamilyActivity.this, R.string.create_im_consult_record_success, Toast.LENGTH_SHORT);
                            }
                            dismissCreateConsultDialog();

//                            if (data == null || TextUtils.isEmpty(data.mOrderNO)) {
//                                PUtils.goToMyService(BuyIMConsultFamilyActivity.this, 0, EventApi.MainTabSelect.MY_COSULT, false);
//                                EventBus.getDefault().post(new EventApi.BuyVVConsultSuc());
//                                finish();
//                            } else {
//                                PayActivity.startPayActivity(BuyIMConsultFamilyActivity.this, data.mOrderNO, "0", type, PayActivity.BUY_IM, true
//                                        , mConsultType != HttpUserConsults.DUTY);
//                            }
                            if (!TextUtils.isEmpty(data.mChannelID)) {
                                TimApplication.enterTimchat(BuyIMConsultFamilyActivity.this, data.mChannelID, mDoctorName, true);
                            }else{
                                ToastUtils.show(BuyIMConsultFamilyActivity.this, "没有房间号", Toast.LENGTH_SHORT);
                            }
                        }
                    }
            );
...
//        }
    ...
    private AdapterView.OnItemClickListener mItemClick = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            MultiImageSelector.create(BuyIMConsultFamilyActivity.this)
                    .showCamera(true)
                    .count(3)
                    .multi()
                    .origin(mSelectPath)
                    .start(BuyIMConsultFamilyActivity.this, REQUEST_IMAGE);
    ...
    private void getMemberDefault() {//获取默认成员
        ...
        new HttpClient(BuyIMConsultFamilyActivity.this, event).start();
    }
...
//            @Override
//            public void onError(int code, String msg) {
//                ToastUtils.showShort(BuyIMConsultFamilyActivity.this, getString(R.string.check_user_package_fail));
//            }
//
//            @Override
...
//            }
//        });
//        new HttpClient(BuyIMConsultFamilyActivity.this, checkUserPackage).start();
//    }

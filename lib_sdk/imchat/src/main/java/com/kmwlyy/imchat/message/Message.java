...
import com.kmwlyy.imchat.utils.TimeUtil;
...
public abstract class Message {
     ...
     * @param viewHolder 界面样式
     */
    public RelativeLayout getBubbleView(ChatAdapter.ViewHolder viewHolder,Boolean showName){
        ...
        if (message.isSelf()){
            ...
            if (message.getConversation().getType() == TIMConversationType.Group){
                viewHolder.sender.setVisibility(showName?View.VISIBLE:View.GONE);
                String name = "";

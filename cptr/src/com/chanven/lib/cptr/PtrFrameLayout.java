...
public class PtrFrameLayout extends ViewGroup {
    ...
    protected boolean mPullToRefresh = false;
    ...
    public PtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (arr != null) {
            ...
            isHideHeader = arr.getBoolean(R.styleable.PtrFrameLayout_ptr_is_hide_header, false);
            arr.recycle();
        }
     ...
     */
    public void setHideHeaderView(boolean hide) {
        if (hide) {
            if (mHeaderView != null) {
    ...
    public ListViewHandler.ScorllListener getScorllListener() {
        return scorllListener;
    }

    public void setScorllListener(ListViewHandler.ScorllListener scorllListener) {
        this.scorllListener = scorllListener;
    }

    private ListViewHandler.ScorllListener scorllListener;
        ...
        if (!hasInitLoadMoreView && isLoadMoreEnable) {
            ...
            if (null == mLoadMoreHandler) {
                if (mContentView instanceof GridView) {
                    ...
                    ((ListViewHandler) mLoadMoreHandler).setScorllListener(scorllListener);
...
//        mLoadMoreView.showNomore();//显示不显示更多数据

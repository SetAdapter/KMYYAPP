...
public class NetworkUtils {
    ...
    public static boolean isConnectedToMobile(Context context) {
        ...
        LogUtils.d(TAG, "checking if device is connected to  mobile network");
    ...
    public static boolean isConnectedToWifi(Context context) {
        ...
        LogUtils.d(TAG, "checking if device is connected to wifi");
    ...
    public static boolean isConnectedToNetwork(Context context) {
        ...
        LogUtils.d(TAG, "device is connected to network : " + isConnected);
        return isConnected;
    }
}

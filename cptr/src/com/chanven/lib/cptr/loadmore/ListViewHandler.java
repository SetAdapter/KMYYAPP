...
public class ListViewHandler implements LoadMoreHandler {
    ...
    public ScorllListener getScorllListener() {
        return scorllListener;
    }

    public void setScorllListener(ScorllListener scorllListener) {
        this.scorllListener = scorllListener;
    }

    private ScorllListener scorllListener;
    ...
    public void setOnScrollBottomListener(View contentView, OnScrollBottomListener onScrollBottomListener) {
        ...
        listView.setOnScrollListener(new ListViewOnScrollListener(onScrollBottomListener,scorllListener));
    ...
    private static class ListViewOnScrollListener implements OnScrollListener {
        ...
        public ListViewOnScrollListener(OnScrollBottomListener onScrollBottomListener, ScorllListener scorllListener) {
            super();
            this.onScrollBottomListener = onScrollBottomListener;
            this.scorllListener = scorllListener;
        }
        ...
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
            if (scorllListener != null) {
                scorllListener.onScroll(view, firstVisibleItem, visibleItemCount, totalItemCount);
            }
        }
    }

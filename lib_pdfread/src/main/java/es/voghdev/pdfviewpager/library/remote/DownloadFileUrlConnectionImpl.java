...
public class DownloadFileUrlConnectionImpl implements DownloadFile {
    ...
    @Override
    public void download(final String[] headers, final String url, final String destinationPath) {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    urlConnection.setRequestProperty("sign",headers[0]);
                    urlConnection.setRequestProperty("noncestr",headers[1]);
                    urlConnection.setRequestProperty("apptoken",headers[2]);
                    urlConnection.setRequestProperty("usertoken",headers[3]);
                    /**
                     * -----------------------------------------------------------------
                     */

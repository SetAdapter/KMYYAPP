 ...
 * 语音咨询 和 视频咨询列表使用的接口
 */
public class HttpGetWaitPatientEvent extends HttpEvent<List<ConsultBeanNew>> {
     ...
     */
    public HttpGetWaitPatientEvent(String CurrentPage, String OPDType, String Keyword, HttpListener<List<ConsultBeanNew>> listener) {
        super(listener);

...
public class OnlineDiagnoseActivity extends BaseActivity implements PageListView.OnPageLoadListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPageListViewHelper = new PageListViewHelper<>(mDoctorPageListView, new OnlineDiagnoseFragment.DoctorListAdapter(OnlineDiagnoseActivity.this, null));
//        mPageListViewHelper.getListView().setDividerHeight(0);
        ...
        mPageListViewHelper.getListView().setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                DoctorServiceActivity.startDoctorServiceActivity(OnlineDiagnoseActivity.this, listItem);
            }
        });
    ...
    private void getDoctorList(final boolean refresh, String keyWord) {
        ...
        mGetDoctorListClient = NetService.createClient(OnlineDiagnoseActivity.this, getList);

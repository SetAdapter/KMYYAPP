...
public class SplashActivity extends FragmentActivity implements SplashView,TIMCallBack{
    ...
    private void init(){
        ...
        String id =  "86-18926452609";//TLSService.getInstance().getLastUserIdentifier();
        String sign = "eJx1zk9vgjAYx-E7r6Lp1f1pC7RlNyZoXFzMJtvw1BRbtBKkw7phlr13DTEZlz3X7yf5PT8eAABm8*WdXK*b494Jd7IaggcAWUTgzV*21ighnfBb1WccoMvh0PcHSnfWtFrI0um2VySMyIUNiFF670xproDTW8wjQoOQUBQN3EFVoh-9f*1gNn18Tlfj2cv4fWVZ-p1*llnK6wUqJuZJT2kRNOaxa5KPjBUJcbKu0lE828bzikRTtju*5bn-inY24ZkbLe47xTbctfWXjgO1RZLSiR5MOlPr60MMUxYyTKD3650BH*xXLA__";
        UserInfo.getInstance().setId(id);
        UserInfo.getInstance().setUserSig(sign);//TLSService.getInstance().getUserSig(id));
